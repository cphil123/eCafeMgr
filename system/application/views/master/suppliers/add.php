<div class="sub_kanan">
<h2>Supplier &raquo; Add</h2><hr noshade>
<div class="error">
<?= validation_errors(); ?>
</div>
...
<table width="60%" border="0" cellpadding="5" cellspacing="0" class="tbview">
  ...
  <tr>
    ...
    <td width="10">:</td>
    <td><input name="addr" type="text" id="addr" size="64" maxlength="64" /></td>
  </tr>
  <tr>
    <td>Supplier: <strong>City</strong></td>
    <td width="10">:</td>
    <td><input name="city" type="text" id="city" size="32" maxlength="64" /></td>
  </tr>
  <tr>
    <td>Supplier: <strong>Province</strong></td>
    <td width="10">:</td>
    <td><input name="prov" type="text" id="prov" size="32" maxlength="64" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="10">:</td>
    <td><input name="phone" type="text" id="phone" size="16" maxlength="16" /></td>
  </tr>
</table>
<div>&nbsp;</div>
<input type="button" value="Save [&radic;]" onclick="javascript:formpost('f_supplier', '<?= base_url() . 'master/Suppliers/adding' ?>');">&nbsp;
