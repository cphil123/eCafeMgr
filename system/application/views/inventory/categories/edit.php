<div class="sub_kanan">
<h2>Categories &raquo; Edit</h2><hr noshade>
<?= validation_errors(); ?>
<form id="f_categories" method="post">
...
<div>&nbsp;</div>
<input type="button" value="Save [&radic;]" onclick="formpost('f_categories', '<?= base_url() ?>inventory/Categories/editing/<?= $catid ?>');">&nbsp;
