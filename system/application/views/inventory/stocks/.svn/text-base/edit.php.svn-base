<div class="sub_kanan">
<h2>Raw Materials &raquo; Edit</h2><hr noshade>
<?= validation_errors(); ?>
...
<table width="40%" border="0" cellpadding="5" cellspacing="0" class="tbview">
  ...
  <tr>
    ...
    <td width="10">:</td>
    <td>
        <select name="locid"><?= $sel_loc ?></select>
    </td>
  </tr>
  <tr>
    <td>Name</td>
...
<div>&nbsp;</div>
<input type="button" value="Save [&radic;]" onclick="formpost('f_stocks', '<?= base_url() ?>inventory/Stocks/editing/<?= $matid ?>');">&nbsp;
