<div class="sub_kanan">
<h2>Position &raquo; Edit</h2><hr noshade>
<?= validation_errors(); ?>
<form id="f_position" method="post">
<table width="40%" border="0" cellpadding="5" cellspacing="0" class="tbview">
  <tr>
    <td>Position: <strong>Name</strong></td>
    <td width="10">:</td>
    <td><input name="name" type="text" id="name" size="32" maxlength="64" value="<?= set_value('name', $name); ?>"></td>
  </tr>
</table>
<div>&nbsp;</div>
<input type="button" value="Save [&radic;]" onclick="formpost('f_position', '<?= base_url() ?>employees/Position/editing/<?= $posid ?>');">&nbsp;
