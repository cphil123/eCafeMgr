<div class="sub_kanan">
<h2>Employees &raquo; Add</h2><hr noshade>
<?= validation_errors(); ?>
...
<table width="60%" border="0" cellpadding="5" cellspacing="0" class="tbview">
  ...
  <tr>
    ...
    <td width="10">:</td>
    <td><input name="name" type="text" id="name" size="16" maxlength="64" value="<?= set_value('name', $name); ?>"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="10">:</td>
    <td><input name="bplace" type="text" id="bplace" size="16" maxlength="32" value="<?= set_value('bplace', $bplace); ?>"></td>
  </tr>
  <tr>
    <td>Employees: <strong>Address</strong></td>
    <td width="10">:</td>
    <td><input name="addr" type="text" id="addr" size="48" maxlength="64" value="<?= set_value('addr', $addr); ?>"></td>
  </tr>
  <tr>
    <td>Employees: <strong>City</strong></td>
    <td width="10">:</td>
    <td><input name="city" type="text" id="city" size="16" maxlength="32" value="<?= set_value('city', $city); ?>"></td>
  </tr>
  <tr>
    <td>Employees: <strong>Province</strong></td>
    <td width="10">:</td>
    <td><input name="prov" type="text" id="prov" size="16" maxlength="32" value="<?= set_value('prov', $prov); ?>"></td>
  </tr>
  <tr>
...
<div>&nbsp;</div>
<input type="button" value="Save [&radic;]" onclick="formpost('f_employees', '<?= base_url() ?>employees/Employees/adding');">&nbsp;
